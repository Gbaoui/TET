...
interface ComponentRenderOptions extends Pick<RenderOptions, 'action' | 'cData' | 'theme' | 'retry' | 'language' | 'execution' | 'appearance'> {
    /**
     * The tabindex of Turnstile’s iframe for accessibility purposes.
     * @default 0
     */
...
type TurnstileLangCode = 'ar' | 'ar-EG' | 'de' | 'en' | 'es' | 'fa' | 'fr' | 'id' | 'it' | 'ja' | 'ko' | 'nl' | 'pl' | 'pt' | 'pt-BR' | 'ru' | 'tr' | 'zh-CN' | 'zh-TW';
...
export { DEFAULT_CONTAINER_ID, DEFAULT_ONLOAD_NAME, DEFAULT_SCRIPT_ID, SCRIPT_URL, Turnstile, TurnstileInstance, TurnstileLangCode, TurnstileProps, TurnstileServerValidationErrorCode, TurnstileServerValidationResponse, TurnstileTheme };
