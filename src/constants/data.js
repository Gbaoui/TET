...
export const projects = [
    {
        title: 'ALAK SHOP',
        src: '/assets/images/projects/pan.png',
        details: {
            technologies: [
                {
                    title: 'HTML',
    ...
    {
        title: 'FOODERA',
        src: '/assets/images/projects/z.png',
        details: {
    ...
    {
        title: 'Shopper',
        src: '/assets/images/projects/pp.png',
        details: {
...
export const socialMedias = [
    {
        href: 'mailto:gbaoui.abdellah@gmail.com',
        ariaLabel: 'Compose an email ',
        title: 'Write an Email',
        Icon: Icons.EmailIcon,
    },
    {
        href: 'https://www.linkedin.com/in/abdellah-gbaoui-a330b6237/',
        title: 'LinkedIn Profile',
        Icon: Icons.LinkedInIcon,
    },
    {
        href: 'https://github.com/Gbaoui',
...
export const techSkills = [
    ...
    {
        category: 'Build Tools and Versioning',
        skills: [
            {
                title: 'Vite',
                Icon: Icons.ViteIcon,
